# Publishes Thunderstore\DefenseBudget.zip to Thunderstore via tcli.
...
tcli publish --config-path (Join-Path $ts 'thunderstore.toml') --file (Join-Path $ts 'DefenseBudget.zip') --token $Token
