...
OUT = "D:/source/DefenseBudget/mods/DefenseBudget/DefenseBudget/models"
TARGET_FACES = 8000
TEX_SIZE = 512
...
def render_preview(obj, item):
    ...
    scene.render.filepath = f"D:/source/DefenseBudget/mods/DefenseBudget/models/clean/{item}_preview.png"
