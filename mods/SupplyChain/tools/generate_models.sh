#!/bin/bash
# Submits SupplyChain reference images to the local TRELLIS.2 container (512 res — the
...
set -u
RAW=/d/source/DefenseBudget/mods/SupplyChain/models/raw
...
for item in bulk_order loaded_dice standing_order force_multiplier pyramid_scheme purchase_order recall_notice; do
