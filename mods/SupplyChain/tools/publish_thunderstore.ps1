# Publishes Thunderstore\SupplyChain.zip to Thunderstore via tcli.
...
tcli publish --config-path (Join-Path $ts 'thunderstore.toml') --file (Join-Path $ts 'SupplyChain.zip') --token $Token
