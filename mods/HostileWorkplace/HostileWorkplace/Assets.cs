...
namespace HostileWorkplace
{
    ...
    internal static class Assets
    {
        ...
        // active â€” instantiated pickups then spawn active.
        internal static Transform PrefabHolder
        {
            get
            {
                if (!prefabHolder)
                {
                    prefabHolder = new GameObject("HostileWorkplacePrefabHolder");
        ...
        // during plugin Awake â€” set the private deprecatedTier directly (reflection, because
