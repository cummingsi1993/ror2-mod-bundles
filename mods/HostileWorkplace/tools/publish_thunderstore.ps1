# Publishes Thunderstore\HostileWorkplace.zip to Thunderstore via tcli.
...
tcli publish --config-path (Join-Path $ts 'thunderstore.toml') --file (Join-Path $ts 'HostileWorkplace.zip') --token $Token
